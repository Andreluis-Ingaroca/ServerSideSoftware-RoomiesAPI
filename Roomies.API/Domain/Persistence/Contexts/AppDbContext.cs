...
namespace Roomies.API.Domain.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Plan Entity
            builder.Entity<Models.Plan>().ToTable("Plans");

            // Constraints

            builder.Entity<Models.Plan>().HasKey(p => p.Id);
            builder.Entity<Models.Plan>().Property(p => p.Id).IsRequired().ValueGeneratedOnAdd();
            builder.Entity<Models.Plan>().Property(p => p.Price).IsRequired();
            builder.Entity<Models.Plan>().Property(p => p.Name).IsRequired().HasMaxLength(50);
            builder.Entity<Models.Plan>().Property(p => p.Description).IsRequired().HasMaxLength(200);
