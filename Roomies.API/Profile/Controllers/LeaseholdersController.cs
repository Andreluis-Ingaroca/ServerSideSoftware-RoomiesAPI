...
namespace Roomies.API.Controllers
{
    ...
    public class LeaseholdersController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpPost("users/{userId}/plans/{planId}/leaseholders")]
        public async Task<IActionResult> PostAsync([FromBody] SaveLeaseholderResource resource,int planId,int userId)
        {
